...
function setup(){
  ...
  /*  player = createSprite(500,500);
   ...
   //creating paddles 
    ...
    p8 = new Paddle(500,572,30,3,"green");
    p9 = new Paddle(505,572,60,5,"blue");
    p10 = new Paddle(450,532,30,3,"blue");
    p11= new Paddle(555,532,30,3,"blue");
    p12 = new Paddle(500,500,30,3,"green");
    p13 = new Paddle(460,473,30,3,"green");
    p14 = new Paddle(545,473,30,3,"green");
